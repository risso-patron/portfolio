...
- [Ver Demo](https://risso-patron.github.io/portfolio/weather-app/) | [Ver Código](https://github.com/risso-patron/portfolio/tree/main/weather-app)
...
- [Ver Demo](https://risso-patron.github.io/portfolio/pomodoro-timer/) | [Ver Código](https://github.com/risso-patron/portfolio/tree/main/pomodoro-timer)

### Budget App
**App de finanzas personales con gráficos**
- Stack: HTML5, CSS3, JavaScript, Chart.js, LocalStorage
- Features: Gestión de ingresos/gastos, gráficos, categorías
- [Ver Demo](https://risso-patron.github.io/portfolio/budget-app/) | [Ver Código](https://github.com/risso-patron/portfolio/tree/main/budget-app)
...
├── budget-app/           # Proyecto: Budget App
...
![Responsive](https://img.shields.io/badge/Responsive-Design-ff6b6b?style=flat-square)
...
**¿Tienes una oportunidad para un developer junior?**  
...
[![Email](https://img.shields.io/badge/Email-Contactar-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:luisrissopa@gmail.com)
...
### Frontend  stack: ["HTML5", "CSS3", "JavaScript", "Git", "GitHub"],

- HTML5 (Semántica)  aprendiendo: ["React", "TypeScript", "Node.js"],

- CSS3 (Flexbox, Grid, Variables, Animations)  busco: "Primera oportunidad como developer frontend",

- JavaScript ES6+ (Vanilla)  contacto: "+507 6456-0263"
...
El portfolio está desplegado automáticamente en GitHub Pages:### Frontend
...
# Abrir con Live Server o Python![REST API](https://img.shields.io/badge/REST_API-02569B?style=flat-square&logo=api&logoColor=white)

python -m http.server 8000![JSON](https://img.shields.io/badge/JSON-000000?style=flat-square&logo=json&logoColor=white)

![LocalStorage](https://img.shields.io/badge/LocalStorage-FFA500?style=flat-square)

# Abrir en navegador

# http://localhost:8000### Aprendiendo

```![React](https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black&opacity=0.6)
...
- Almacenamiento local## Estadísticas GitHub

- Notificaciones sonoras

- Diseño zen minimalista<div align="center">
...
- Gráficos interactivos## Experiencia Relevante

- Filtros por categoría

- LocalStorage**Space Panamá** *(2021 - Presente)*  
...
### Sistema de Temas- Optimización de performance y SEO técnico

- Toggle dark/light con animación

- Persistencia con localStorage---

- Prevención de FOUC (Flash of Unstyled Content)

- Variables CSS dinámicas## 🎓 Aprendizaje Continuo



### Animaciones```javascript

- Scroll reveal con IntersectionObserver// Mi hoja de ruta de aprendizaje 2025

- Hover effects en cards y botonesconst roadmap = {

- Carrusel infinito de tecnologías  actual: {

- Transiciones suaves    frontend: ["HTML5", "CSS3", "JavaScript ES6+"],

    tools: ["Git", "GitHub", "VS Code", "Chrome DevTools"]

### Responsive Design  },

- Mobile First approach  siguiente: {

- Breakpoints: 1024px, 768px, 480px    framework: "React.js",

- Imágenes optimizadas    lenguaje: "TypeScript", 

- Clamp() para tipografía fluida    backend: "Node.js + Express",
...
- [MEJORAS-DESIGN.md](./MEJORAS-DESIGN.md) - Mejoras de diseño implementadas};

- [THEME-SYSTEM.md](./THEME-SYSTEM.md) - Sistema de temas```

- [THEME-FIX.md](./THEME-FIX.md) - Correcciones del tema

- [TECH-SLIDER-ANIMATION.md](./TECH-SLIDER-ANIMATION.md) - Carrusel de tecnologías---
...
**Jorge Luis Risso Patrón**<div align="center">
...
**Última actualización**: Noviembre 2025<div align="center">


### � "Cada línea de código es un paso hacia mi primera oportunidad en tech"
